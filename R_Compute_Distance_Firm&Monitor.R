...
# ==================================================
# Why we do this? Define treated group/control group
#   - Based on these distances, a firm is considered treated in the year when the first monitor within 20 km was automated.
#   - If multiple monitors within 20 km were automated in the same year, we assign the nearest one as the treatment source. 
# ==================================================
# Source: 
#     Firm -- taxsurvey data
#     monitor -- full list
...
# NOTE: please change `root_dir` to your own project path if you run this script on a different machine.
root_dir <- "/Users/tangheng/Dropbox/Green TFP China"
setwd(root_dir)
